      ...
      <div className="bg-white text-slate-800 p-6 md:p-8 font-sans text-xs leading-relaxed min-h-[500px] w-full max-w-[800px] mx-auto overflow-x-auto">
        ...
        <div className="flex justify-between items-start mb-8 border-b-2 border-slate-100 pb-6">
          ...
          <div className="text-right">
            <h2 className="text-2xl font-black text-indigo-600 tracking-tight m-0">Tax Invoice</h2>
        ...
        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 mb-6">
          <h3 className="text-[10px] font-black text-slate-500 tracking-widest mb-3">Billed To Distributor:</h3>
          {sale.customer ? (
            <>
          ...
          <table className="w-full min-w-[500px] border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 text-left">
                <th className="p-3 text-slate-500 font-bold text-[10px]">#</th>
                <th className="p-3 text-slate-500 font-bold text-[10px] w-2/5">Item Description</th>
                <th className="p-3 text-slate-500 font-bold text-[10px] w-1/5">Pack / Size</th>
                <th className="p-3 text-slate-500 font-bold text-[10px] text-center">Qty</th>
                <th className="p-3 text-slate-500 font-bold text-[10px] text-right">Unit Price</th>
                <th className="p-3 text-slate-500 font-bold text-[10px] text-right">Total</th>
              </tr>
            </thead>
        ...
        <div className="mt-12 pt-6 border-t border-slate-200">
          ...
          <div className="flex justify-end">
            <p className="text-[10px] font-semibold text-slate-400">Generated by Inzeedo ERP System</p>
          </div>
        </div>
      </div>
    );
