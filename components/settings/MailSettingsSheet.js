...
const InputField = memo(({ label, icon: Icon, children, hint }) => (
  <div className="flex flex-col gap-1.5">
    <label className="text-sm font-semibold text-text-secondary pl-1 opacity-70 ">{label}</label>
    ...
    <div className="flex items-center justify-between p-4 bg-surface-muted/50 rounded-2xl border border-glass-border/20">
      <div className="flex items-center gap-4">
        ...
        <div className="text-left">
          <p className="text-[13px] font-semibold text-text-main leading-tight">{label}</p>
            ...
            <div className="flex-1 overflow-y-auto px-8 no-scrollbar pb-40">
              {loading ? (
                <div className="flex flex-col items-center justify-center py-20 gap-4 opacity-50">
                  ...
                  <p className="text-sm font-bold text-text-secondary uppercase tracking-widest">Loading Settings...</p>
                </div>
              ) : (
                  ...
                  {emailEnabled && (
                    <div className="flex flex-col gap-5 animate-in fade-in slide-in-from-top-4 duration-300">
                      <div className="px-4 -mt-4 mb-2">
                        <p className="text-[11px] font-bold text-text-secondary opacity-60 leading-relaxed text-center">
                          SMTP configuration is managed via the Web Dashboard. The gateway is currently active.
                        </p>
                      </div>
                      ...
                      {alerts.lowStock.enabled && (
                        <div className="px-4 -mt-4 mb-2 animate-in fade-in slide-in-from-top-2 duration-300">
