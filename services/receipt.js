...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 13px; color: #000000; background: #fff; line-height: 1.5; }
...
<body>
  ...
  <div class="wrap">
    ...
    <!-- Distributor -->
    <div style="background:#ffffff;border:1px solid #cccccc;border-radius:10px;padding:20px;margin-bottom:28px;">
    ...
    <div style="margin-top:36px;padding-top:20px;border-top:1px solid #cccccc;">
      ...
      <div style="font-size:11.5px;color:#000000;line-height:1.7;margin-bottom:28px;">
        ${refundPolicy ? `<div><span style="font-weight:700;color:#000000;">Terms &amp; Conditions:</span> ${refundPolicy}</div>` : ''}
        ${footerText ? `<div>${footerText}</div>` : '<div style="font-weight:600;color:#000000;">Thank you for your business!</div>'}
      </div>
...
<div style="border-top:1px solid #000;padding-top:12px;display:flex;justify-content:space-between;align-items:flex-end;">
  <div>
    ...
    ${footerText ? `<div style="font-size:10px;margin-top:3px;">${footerText}</div>` : '<div style="font-size:11px;font-weight:600;">Thank you for your business!</div>'}
